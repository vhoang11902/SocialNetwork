...
import com.tvh.filters.CustomAccessDeniedHandler;
import com.tvh.filters.JwtAuthenticationTokenFilter;
import com.tvh.filters.RestAuthenticationEntryPoint;
...
public class JwtSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.antMatcher("/api/**").httpBasic().authenticationEntryPoint(restServicesEntryPoint()).and()
                ...
                .antMatchers(HttpMethod.POST, "/api/**").access("hasRole('ROLE_ADMIN') or hasRole('ROLE_USER')").and()
